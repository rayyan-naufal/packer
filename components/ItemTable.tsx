...
// Perhatikan 'export' ditambahkan di sini
export const ItemTable: React.FC<ItemTableProps> = ({ items, onUpdateItem, categories }) => {
  return (
...
// Baris 'export default ItemTable;' dihapus dari sini
